const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Chatbot account',
    langGeniusAccountTip: 'Your Chatbot account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Chatbot to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Chatbot allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Chatbot\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Chatbot {{version}} is now available.',
    latestAvailable: 'Chatbot {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
