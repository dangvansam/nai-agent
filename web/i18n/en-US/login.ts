const translation = {
  ...
  license: {
    tip: 'Before starting Chatbot Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Chatbot',
  invalid: 'The link has expired',
  explore: 'Explore Chatbot',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Chatbot and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Chatbot Enterprise license for your workspace has expired. Please contact your administrator to continue using Chatbot.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Chatbot license server. Please contact your administrator to continue using Chatbot.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Chatbot Enterprise license for your workspace is inactive. Please contact your administrator to continue using Chatbot.',
}
