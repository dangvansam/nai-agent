const translation = {
  ...
  newApp: {
    ...
    agentDescription: 'Xây dựng một chuyên viên thông minh có thể tự động chọn công cụ để hoàn thành các nhiệm vụ',
    ...
    agentUserDescription: 'Một chuyên viên thông minh có khả năng suy luận lặp đi lặp lại và sử dụng công cụ tự động để đạt được mục tiêu nhiệm vụ.',
    ...
    agentShortDescription: 'Chuyên viên thông minh với lý luận và sử dụng công cụ tự động',
