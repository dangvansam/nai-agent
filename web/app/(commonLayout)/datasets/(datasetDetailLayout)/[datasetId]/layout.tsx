            ...
            <a
              ...
              href={
                locale === LanguagesSupported[1]
                  ? 'https://docs.Chatbot.ai/guides/knowledge-base/integrate-knowledge-within-application'
                  : 'https://docs.Chatbot.ai/guides/knowledge-base/integrate-knowledge-within-application'
              }
...
const DatasetDetailLayout: FC<IAppDetailLayoutProps> = (props) => {
  ...
  useEffect(() => {
    if (datasetRes)
      document.title = `${datasetRes.name || 'Dataset'} - Chatbot`
  }, [datasetRes])
  ...
  return (
    <div className='grow flex overflow-hidden'>
      {!hideSideBar && <AppSideBar
        ...
        icon={datasetRes?.icon || 'https://static.Chatbot.ai/images/dataset-default-icon.png'}
